    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <plan.icon className="mb-6 text-purple-400" size={36} />
              ...
              <button className="mt-8 w-full rounded-xl bg-purple-600 py-3 font-medium transition hover:bg-purple-700">
                {t("Get Started")}
              </button>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-20 rounded-3xl border border-white/10 bg-gradient-to-r from-purple-500/10 to-blue-500/10 p-10 text-center backdrop-blur-xl"
        >
          <Building2 size={48} className="mx-auto text-purple-400" />
          ...
          <button className="mt-8 rounded-xl bg-purple-600 px-8 py-3 font-medium transition hover:bg-purple-700">
            {t("Contact Sales")}
          </button>
        </motion.div>
      </div>
