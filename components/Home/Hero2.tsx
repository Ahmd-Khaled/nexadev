    ...
    <section className="relative pt-16 md:pt-8 pb-10 md:pb-0 overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute left-[-120px] top-[-120px] h-[500px] w-[500px] rounded-full bg-amber-600/20 blur-3xl"
        />

        <motion.div
          animate={{ x: [0, -80, 0], y: [0, -60, 0] }}
          transition={{ duration: 14, repeat: Infinity }}
          className="absolute right-[-120px] bottom-[-120px] h-[500px] w-[500px] rounded-full bg-amber-600/20 blur-3xl"
        />

        <motion.div
          animate={{ x: [0, 50, 0], y: [0, -50, 0] }}
          transition={{ duration: 16, repeat: Infinity }}
          className="absolute left-1/2 top-1/3 h-[400px] w-[400px] -translate-x-1/2 rounded-full bg-amber-500/10 blur-3xl"
        />
      </div>
      ...
      <div className="container relative pt-10 z-10 mx-auto grid min-h-screen items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          >
            {t("Build")}{" "}
            <span className="bg-gradient-to-r from-amber-400 via-yellow-400 to-gray-500 bg-clip-text text-transparent">
              {t("Digital Products")}
            </span>{" "}
            {t("That Scale")}
          </motion.h1>
          ...
          >
            <Link
              href="#contact"
              className="rounded-2xl bg-gradient-to-r from-amber-400 to-yellow-700 px-6 py-3 font-medium transition hover:scale-105"
            >
              {t("Start Project")}
            </Link>
